...
// Source: github.com/hienphamm/simplebank/db/sqlc (interfaces: Store)
...
import (
	...
	sqlc "github.com/hienphamm/simplebank/db/sqlc"
...
func (m *MockStore) DeleteAccount(arg0 context.Context, arg1 int64) (sqlc.Account, error) {
	m.ctrl.T.Helper()
